...
import ContractTestStep from './ContractTestStep';
...
const steps = [
    WelcomeStep,      // 0 — connect MetaMask + faucet
    QuizStep,         // 1 — DeFi 101 quiz
    ArsenalStep,      // 2 — concept cards
    ContractTestStep, // 3 — automated contract tests on devnet  ← NEW
    LendingStep,      // 4 — real deposit + borrow
    SwapStep,         // 5 — real AMM swap
    YieldStep,        // 6 — real stake + claim
    PlaygroundStep,   // 7 — summary + real balances
];
        ...
        <div className="max-w-4xl mx-auto p-6 min-h-screen flex flex-col">
            <header className="mb-8 flex justify-between items-center">
                ...
                <div className="text-right ml-6">
                    <div className="text-sm font-medium text-muted-foreground uppercase tracking-wider">XP</div>
